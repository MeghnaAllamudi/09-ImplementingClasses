...
# ------------------------------------------------------------------------------
# TODO: 2.  DONE        With your instructor, READ THE INSTRUCTIONS in
...
class Point(object):
    ...
    def move_to(self,x,y):
        self.x = x
        self.y = y
        self.change = self.x - self.startx
        self.change1 = self.y - self.starty
        self.changed = math.sqrt(((self.change) ** 2) + ((self.change1) ** 2))
        self.count = self.count + 1
        self.distance = self.distance + self.changed

    def move_by(self,dx,dy):
        self.x = self.x + dx
        self.y = self.y + dy
        self.changed1 = math.sqrt(((dx) ** 2) + ((dy) ** 2))
        self.distance1 = self.distance + self.changed1
        self.count = self.count + 1
    ...
    def get_distance_from(self,Point):
        self.delta = self.x - Point.x
        self.delta1 = self.y - Point.y
        self.total = math.sqrt((self.delta)**2+ (self.delta1)**2)
        return self.total

    def get_distance_from_start(self):
        self.deltax = self.x - self.startx
        self.detlay = self.y - self.starty
        self.totald = math.sqrt((self.deltax)**2+(self.detlay)**2)
        return self.totald
    def get_distance_traveled(self):
        return self.distance + self.distance1
    def closer_to(self,p2,p3):
        self.deltap2 = math.sqrt((self.x-p2.x)**2+(self.y-p2.y)**2)
        self.deltap3 = math.sqrt((self.x-p3.x)**2+(self.y-p3.y)**2)
        if self.deltap2 >= self.deltap3:
            return p2
        else:
            return p3
    def halfway_to(self,p2):
        midptx = (self.x + p2.x)/2
        midpty = (self.y + p2.y)/2
        return Point(midptx,midpty)
...
def run_test_repr():
    ...
    """
    # --------------------------------------------------------------------------
    # TODO: 4.  Follow the same instructions as in _TODO_ 3 above,DONE
...
def run_test_clone():
   ...
   """
    # --------------------------------------------------------------------------
    # TODO: 5.  Follow the same instructions as in _TODO_ 3 above,DONE
...
def run_test_move_by():
    ...
    You may also use this example to test this method.
        ...
        """
    # --------------------------------------------------------------------------
    # TODO: 7.  Follow the same instructions as in _TODO_ 3 above,DONE
...
def run_test_get_number_of_moves_made():
    ...
    """
    # --------------------------------------------------------------------------
    # TODO: 8.  Follow the same instructions as in _TODO_ 3 above,DONE
...
def run_test_get_distance_from():
    ...
    """
    # --------------------------------------------------------------------------
    # TODO: 9.  Follow the same instructions as in _TODO_ 3 above,DONE
...
def run_test_get_distance_traveled():
    ...
    """
    # --------------------------------------------------------------------------
    # TODO: 11.  Follow the same instructions as in _TODO_ 3 above,DONE
